...
echo 'Salom Sobirjon' . "\n"; // Bu yerga comment yozish mumkin
print('5 + 4 = ' . '9'); // Bu yerga ham comment yozish mumkin

/*
Code run qilish uchun`php fundamentals/comments.php` buyrug'ini terminalga yozing!
*/
